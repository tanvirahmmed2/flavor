...
const SideBar = () => {
  ...
  return (
    <div className={`w-[250px] min-h-screen ${sidebar ? "translate-x-0" : "-translate-x-full"} transform transition-transform duration-300 ease-in-out md:hidden flex flex-col items-center justify-between py-12 bg-white fixed top-0 border-r-2 z-50`}>
